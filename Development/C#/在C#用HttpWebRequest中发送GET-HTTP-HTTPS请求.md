...
<span
style="color: rgb(85, 85, 85); font-family: 宋体, 'Arial Narrow', arial, serif; line-height: 28px; widows: 1; background-color: rgb(255, 255, 255);">（1）POST数据到HTTPS站点，用它来登录百度：</span>\
...
<span
style="color: rgb(85, 85, 85); font-family: 宋体, 'Arial Narrow', arial, serif; line-height: 28px; widows: 1; background-color: rgb(255, 255, 255);">（2）发送GET请求到HTTP站点</span>\
...
<span
style="color: rgb(85, 85, 85); font-family: 宋体, 'Arial Narrow', arial, serif; line-height: 28px; widows: 1; background-color: rgb(255, 255, 255);"> 
在cookieString中包含了服务器端返回的会话信息数据，从中提取了之后可以设置Cookie下次登录时带上这个Cookie就可以以认证用户的信息，假设我们已经登录成功并且获取了Cookie，那么发送GET请求的代码如下：</span><span
style="color: rgb(85, 85, 85); font-family: 宋体, 'Arial Narrow', arial, serif; line-height: 28px; widows: 1; background-color: rgb(255, 255, 255);">\
</span>
...
<span
style="color: rgb(85, 85, 85); font-family: 宋体, 'Arial Narrow', arial, serif; line-height: 28px; widows: 1; background-color: rgb(255, 255, 255);">(3)发送POST请求到HTTP站点</span>\
<span
style="color: rgb(85, 85, 85); font-family: 宋体, 'Arial Narrow', arial, serif; line-height: 28px; widows: 1; background-color: rgb(255, 255, 255);"> 以登录51CTO为例：</span>\
